      ...
      <div className="flex-shrink-0 pt-6 sticky bottom-0 bg-white/10 z-10">
        <div className="relative flex items-center">
          <textarea
            ...
            className="w-full rounded-lg py-4 pl-4 pr-20 bg-white/20 text-white placeholder-white/60 border border-[#ff6a00]/40 focus:outline-none focus:ring-2 focus:ring-[#ff6a00]/60 resize-none shadow-xl backdrop-blur-lg"
            rows={1}
            value={inputValue}
